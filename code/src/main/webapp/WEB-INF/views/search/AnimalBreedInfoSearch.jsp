			...
			<ul class="nav metismenu" id="side-menu">
				...
				<li class="active"><a href="#"> <i class="glyphicon glyphicon-search"></i>
					...
					<ul class="nav nav-second-level collapse">
						...
						<li class="active"><a href="${root_path}search/AnimalBreedInfoSearch">动物繁殖记录查询</a>
						</li>
...
<script type="text/javascript">
			...
			<div class="row  border-bottom white-bg dashboard-header"
				id="container_1">
				<h2>实验动物档案管理系统 / 档案查询 / <strong>动物繁殖记录查询</strong></h2>
			</div>
                        	...
                        	<div class="row">
								...
								<label>繁殖描述：</label>
									<div class="form-group input-group input-group-sm">
										...
										<input type="text" class="form-control" name="breeddescription"
											placeholder="请输入繁殖描述...">
									</div>
								</div>
							</div>
...
<script type="text/javascript">
		...
		function to_page(pn) {
			$.ajax({
				url : "${root_path}/search/AnimalBreedInfoSearch/queryBreed",
		...
		function build_emps_table(result) {
			...
			$.each(emps, function(index, item) {
				...
				var hl = $("<td></td>").append(item.breeddescription);

				
				$("<tr></tr>").append(id).append(nb).append(rc).append(rd).append(hl).appendTo("#emps_table tbody");
			});
		}
		//分页条
