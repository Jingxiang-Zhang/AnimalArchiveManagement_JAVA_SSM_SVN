			...
			<ul class="nav metismenu" id="side-menu">
				...
				<li class="active"><a href="#"> <i class="glyphicon glyphicon-search"></i>
					...
					<ul class="nav nav-second-level collapse">
						...
						<li class="active"><a href="${root_path}search/AnimalFeedInfoSearch">动物饲养记录查询</a>
						</li>
...
<script type="text/javascript">
			...
			<div class="row  border-bottom white-bg dashboard-header"
				id="container_1">
				<h2>实验动物档案管理系统 / 档案查询 / <strong>动物饲养记录查询</strong></h2>
			</div>
                        	...
                        	<div class="row">
								...
								<label>饲养前状况：</label>
									<div class="form-group input-group input-group-sm">
										...
										<input type="text" class="form-control" name="statusbeforefeed"
											placeholder="请输入状况...">
									</div>
								</div>
								<div class='col-sm-2'>
								<label>饲养物：</label>
									<div class="form-group input-group input-group-sm">
										<input type="text" class="form-control" name="feedobject"
											placeholder="请输入饲养物...">
									</div>
								</div>
								...
								<label>饲养过程：</label>
									<div class="form-group input-group input-group-sm">
										...
										<input type="text" class="form-control" name="feedprocess"
											placeholder="请输入饲养过程...">
									</div>
								</div>
							</div>
...
<script type="text/javascript">
		...
		function to_page(pn) {
			$.ajax({
				url : "${root_path}/search/AnimalFeedInfoSearch/queryFeed",
		...
		function build_emps_table(result) {
			...
			$.each(emps, function(index, item) {
				...
				var sb = $("<td></td>").append(item.statusbeforefeed);
				var hl = $("<td></td>").append(item.feedobject);
				var des = $("<td></td>").append(item.feedprocess);

				
				$("<tr></tr>").append(id).append(nb).append(rc).append(rd).append(sb).append(hl).append(des).appendTo("#emps_table tbody");
			});
		}
		//分页条
