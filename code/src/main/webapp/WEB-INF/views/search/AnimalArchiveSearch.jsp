	...
	<div id="wrapper">
		...
		<div class="sidebar-collapse">
			<ul class="nav metismenu" id="side-menu">
				...
				<li class="active"><a href="#"> <i class="glyphicon glyphicon-search"></i>
					...
					<ul class="nav nav-second-level collapse">
						<li class="active"><a href="${root_path}search/AnimalArchiveSearch">动物档案查询</a>
						</li>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<div class="row  border-bottom white-bg dashboard-header"
				id="container_1">
				<h2>实验动物档案管理系统 / 档案查询 / <strong>动物档案查询</strong></h2>
			</div>
                        	...
                        	<div class="row">
	                        	<div class='col-sm-2'>
									...
									<div class="form-group input-group input-group-sm">
										<input type="text" class="form-control" name="archivenumber"
											placeholder="请输入档案号...">
									</div>
									</div>
								<div class='col-sm-2'>
									<label>耳标编号：</label>
									<div class="form-group input-group input-group-sm">
										<input type="text" class="form-control" name="eartagnumber"
											placeholder="请输入耳标号...">
									</div>
								</div>
								<div class='col-sm-2'>
									...
									<div class="form-group input-group input-group-sm">
										...
										<input type="text" class="form-control" name="initialpeople"
											placeholder="请输入建档员号...">
									</div>
								</div>
								<div class='col-sm-2'>
									...
									<div class="form-group input-group input-group-sm">
										...
										<input type="text" class="form-control" name="responsiblepeople"
											placeholder="请输入研究员号...">
									</div>
								</div>
								<div class='col-sm-4'>
									...
									<div class="form-group input-group input-group-sm">
										...
										<input type="text" class="form-control" name="belongpeople"
											placeholder="请输入PI号...">
									</div>
								</div>
							...
							<div class="row">
								<div class='col-sm-4'>
									...
									<div class="form-group input-group input-group-sm">
										...
										<input type="text" class="form-control" name="archivekey"
											placeholder="请输入关键字...">
									</div>
								</div>
								<div class='col-sm-8'>
									<label>档案描述：</label>
									<div class="form-group input-group input-group-sm">
										<input type="text" class="form-control" name="archivedescription"
											placeholder="请输入档案描述...">
									</div>
								</div>
							    ...
							    <div class='col-sm-2'>
							        ...
							        <div class="form-group">
							            ...
							            <div class='input-group date input-group-sm' id='datetimepicker1'>
							                <input type='text' class="form-control" name="initialdate" id="r1">
...
<script type="text/javascript">
		...
		function to_page(pn) {
			$.ajax({
				url : "${root_path}/search/AnimalArchiveSearch/searchArchive",
		...
		function build_emps_table(result) {
			...
			$.each(emps, function(index, item) {
				...
				var id = $("<td></td>").append(item.archivenumber);
				var nb = $("<td></td>").append(item.eartagnumber);
				var rd = $("<td></td>").append(date);
				var hl = $("<td></td>").append(item.initialpeople);
				var rb = $("<td></td>").append(item.responsiblepeople);
				var bp = $("<td></td>").append(item.belongpeople);
				var ad = $("<td></td>").append(item.archivedescription);
				var ak = $("<td></td>").append(item.archivekey);

				
				$("<tr></tr>").append(id).append(nb).append(rd).append(hl).append(rb).append(bp).append(ad).append(ak).appendTo("#emps_table tbody");
			});
		}
		//分页条
