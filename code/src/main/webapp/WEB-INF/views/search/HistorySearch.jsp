			...
			<ul class="nav metismenu" id="side-menu">
				...
				<li class="nav-header">
					<div class="dropdown profile-element">
						...
						<a data-toggle="dropdown" class="dropdown-toggle" href="#"> <br />
							<span class="block m-t-xs font-bold text-center">欢迎你，李太白</span>
						</a>
					</div>
				...
				<li><a href="index.html"> <i
					...
					<ul class="nav nav-second-level">
						<li><a
							href="${root_path}add/AddExperimetRecord">动物实验记录添加</a></li>
				...
				<li class="active"><a href="#"> <i class="glyphicon glyphicon-search"></i>
					...
					<ul class="nav nav-second-level collapse">
						...
						<li class="active"><a href="${root_path}search/HistorySearch">历史查询</a>
						</li>
					</ul></li>
