		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header alert alert-success">
					<h4 class="modal-title" id="myModalLabel">是否取消推广？</h4>
...
//页面加载完成后，发送ajax请求，获取分页数据
	...
	function to_page(pn) {
		...
		$.ajax({
		url : "${root_path}advert/all_archive_has_advert/",
			data : "pn=" + pn,
			type : "GET",
	...
	function build_emps_table(result) {
			...
			$.each(emps, function(index, item) { 
				...
				var editbtn = $("<button></button>").addClass(
						...
						$("<span></span>").addClass(
								"glyphicon glyphicon-pencil")).append("取消推广");
...
<script type="text/javascript">
	...
	$(document).on("click", ".edit_btn", function() {
			//查出动物信息
			$("#archive_number_static").text("您取消推广的档案编号为 "+ $(this).attr("edit-id"));
			//把动物的ID传递给更新按钮
