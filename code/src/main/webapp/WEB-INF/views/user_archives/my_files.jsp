                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="${root_path}user_archives/my_files"><strong>所属档案</strong></a>
                        </li>
                        <li  class="breadcrumb-item active">
                            <a href="${root_path}user_archives/paid_files">已购档案</a>
                        </li>
                    </ol>
                </div>
            </div>
                        ...
                        <div class="ibox-content">
							<div class="panel panel-success">
	                        	<div class = "panel-heading"> 
									<h5 class="panel-title text-center">个人所属档案列表</h5>
								</div>
    ...
    <script>
		...
		function to_page(pn) {
			...
			if(user_name==""){
				...
				$.ajax({
					url : "${root_path}user_archives/myfiles/query",
