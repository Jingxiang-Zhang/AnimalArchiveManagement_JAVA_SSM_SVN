...
<body>
			...
			<ul class="nav metismenu" id="side-menu">
				...
				<li class="active"><a href="index.html"> <i
					...
					<ul class="nav nav-second-level">
						...
						<li class="active"><a href="${root_path}add/AddBreedRecord">动物繁殖记录添加</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <h5>Experiment Animal Breed Record Table</h5>
	...
	<script type="text/javascript">	
		...
		function to_page(pn) {
			...
			//用ajax请求查询实验动物档案表
			$.ajax({
				url : "${root_path}/add/LookBreedRecord/query",
