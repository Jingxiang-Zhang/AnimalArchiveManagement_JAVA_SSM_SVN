...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<!----------------在此处完成对应的界面设计 ------------------>
			<div class="wrapper wrapper-content animated fadeInRight ecommerce" id="cmd">               		
               	<!-- 导航 -->
					...
					<ol class="breadcrumb" style='font-size:14px'>
                    	<li class="breadcrumb-item">
                       	...
                       	<li class="breadcrumb-item active">
                           	<strong>动物实验记录添加</strong>
                       	</li>
                   	</ol>
				</div>
	                
                <!-- 搜索栏 -->
               	<div class="ibox-content m-b-sm border-bottom" id="exp_data_modal" style='font-size:14px'>
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="col-form-label" for="product_name">动物档案编号</label>
                                <input type="text" id="animal_achiveID" name="product_name" value=""
	                                    placeholder="动物档案编号" class="form-control" style='font-size:14px'>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="col-form-label" for="price">动物种类</label>
                                <input type="text" id="animal_kind" name="price" value="" placeholder="动物种类"
	                                    class="form-control" style='font-size:14px'>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="col-form-label" for="quantity">动物描述</label>
                                <input type="text" id="animal_description" name="quantity" value="" placeholder="动物描述"
                                    class="form-control" style='font-size:14px'>
                            </div>
                        </div>
                  		<div class="col-sm-3">
                            <div class="form-group">
                                <label class="col-form-label" for="quantity">动物来源</label>
                                <input type="text" id="animal_orgi" name="quantity" value="" placeholder="动物来源"
                                    class="form-control" style='font-size:14px'>
                            </div>
                        </div>                  
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox">
                            <div class="ibox-content">
                                <table class="table table-stripped toggle-arrow-tiny" data-page-size="5" id="emps_table">
                                	<!-- 表头 -->
                                    <thead>
                                        <tr>
                                            <th data-toggle="true">动物档案编号</th>
                                            <th data-hide="phone">种类</th>
                                            <th data-hide="phone">描述</th>     
                                            <th data-hide="phone">来源</th>	                                                                                  
                                            <th data-hide="phone">性别</th>
                                            <th data-hide="phone">血型</th>
                                            <th data-hide="phone">身高/cm</th>
                                            <th data-hide="phone">体重/kg</th>                                                                                                                                   
           	...
           	<!-- 添加信息模态框 -->
			<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" id="experiment_add_modal" >
			    		...
			    		<!-- 表单 -->
			      		<form class="form-horizontal" id="add_form">
							...
							<div class="form-group">
						    	...
						    	<div class="col-lg-3">
						      		<input type="text" name="experimentnumber" id="experimentnumber" style='font-size:14px' class="form-control" readonly="readonly">
						    	</div>
						    	<label style='font-size:14px' class="col-lg-2 col-lg-offset-1 control-label">实验记录表编号：</label>
						    	<div class="col-lg-3 ">
						      		<input type="text" name="ID" id="ID" style='font-size:14px' class="form-control" readonly="readonly">
						    	</div>
						  	</div>
						  	<div class="form-group">
						    	<label style='font-size:14px' class="col-lg-2 control-label">实验记录员编号：</label>
						    	<div class="col-lg-3">
						      		<input type="text" name="experimenternumber" id="experimenternumber" style='font-size:14px' class="form-control" readonly="readonly">
						    	</div>	
						    	<label style='font-size:14px' class="col-lg-2 col-lg-offset-1 control-label">实验日期：</label>
						    	<div class="col-lg-3">
						      		<input type="text" name="experimentdate" id="experimentdate" style='font-size:14px' class="form-control" placeholder="yyyy-mm-dd">
						    		<!-- 显示错误信息 -->
									<div class="invalid-feedback" style="color:red" id="experimentdate_input_feedback"></div>
						    	</div>
						  	</div>						  	
		  					<div class="form-group">
						    	<label style='font-size:14px' class="col-lg-2 control-label">实验地点：</label>
						    	<div class="col-lg-9">
						      		<textarea class="form-control" name="experimentlocation" id="experimentlocation" rows="1" style='font-size:14px' placeholder="精确到门牌号"></textarea>
						    		<!-- 显示错误信息 -->
									<div class="invalid-feedback" style="color:red" id="experimentlocation_input_feedback"></div>
						    	</div>					
						  	</div>
						  	<div class="form-group">
						    	<label style='font-size:14px' class="col-lg-2 control-label">实验目的：</label>
						    	<div class="col-lg-9">
						      		<textarea class="form-control" name="experimentpurpose" id="experimentpurpose" rows="5" style='font-size:14px' placeholder="详细描述实验目的，255字以内"></textarea>
						    		<!-- 显示错误信息 -->
									<div class="invalid-feedback" style="color:red" id="experimentpurpose_input_feedback"></div>
						    	</div>					
						  	</div>
						  	<div class="form-group">
						    	<label style='font-size:14px' class="col-lg-2 control-label">实验方案：</label>
						    	<div class="col-lg-9">
						      		<textarea class="form-control" name="experimentapproach" id="experimentapproach" rows="5" style='font-size:14px' placeholder="详细描述实验方案，255字以内"></textarea>
						    		<!-- 显示错误信息 -->
									<div class="invalid-feedback" style="color:red" id="experimentapproach_input_feedback"></div>
						    	</div>					
						  	</div>
						  	<div class="form-group">
						    	<label style='font-size:14px' class="col-lg-2 control-label">实验过程：</label>
						    	<div class="col-lg-9">
						      		<textarea class="form-control" name="experimentrecord" id="experimentrecord" rows="5" style='font-size:14px' placeholder="详细描述实验过程，255字以内"></textarea>
						    		<!-- 显示错误信息 -->
									<div class="invalid-feedback" style="color:red" id="experimentrecord_input_feedback"></div>
						    	</div>					
						  	</div>	
						  	<div class="form-group">
						    	<label style='font-size:14px' class="col-lg-2 control-label">实验结果：</label>
						    	<div class="col-lg-9">
						      		<textarea class="form-control" name="experimentresult" id="experimentresult" rows="5" style='font-size:14px' placeholder="详细描述实验结果，255字以内"></textarea>
						    		<!-- 显示错误信息 -->
									<div class="invalid-feedback" style="color:red" id="experimentresult_input_feedback"></div>
						    	</div>					
						  	</div>	
						  	<div class="form-group">
						    	<label style='font-size:14px' class="col-lg-2 control-label">实验备注：</label>
						    	<div class="col-lg-9">
						      		<textarea class="form-control" name="experimentnote" id="experimentnote" rows="5" style='font-size:14px' placeholder="备注，255字以内"></textarea>
						    		<!-- 显示错误信息 -->
									<div class="invalid-feedback" style="color:red" id="experimentnote_input_feedback"></div>
						    	</div>					
						  	</div>							  
						</form>
						<!-- 按钮 -->
						<div class="modal-footer">
       						<button type="button" class="btn btn-default col-lg-1 col-lg-offset-8" data-dismiss="modal">关闭</button>
       						<button type="button" class="btn btn-primary col-lg-2" id="submit_btn" data-dismiss="modal">添加到数据库</button>
   						</div>
		    		</div>
			  	</div>				  	
			</div>	
    ...
    <script type="text/javascript">               
		...
		$(function() {
			...
			//为四个搜索框分别绑定输入框改变事件，当搜索框中有文字改变事件发生时，调用to_page_input_change函数重新搜索数据库并刷新在表格中的显示
			...
			/*日期输入框绑定前端校验*/
			$("#experimentpurpose").bind('input propertychange', function() {
				string_validate("#experimentpurpose");
			}); 
			
			/*日期输入框绑定前端校验*/
			$("#experimentapproach").bind('input propertychange', function() {
				string_validate("#experimentapproach");
			}); 
			
			/*日期输入框绑定前端校验*/
			$("#experimentrecord").bind('input propertychange', function() {
				string_validate("#experimentrecord");
			}); 
			
			/*日期输入框绑定前端校验*/
			$("#experimentresult").bind('input propertychange', function() {
				string_validate("#experimentresult");
			});
			
			/*日期输入框绑定前端校验*/
			$("#experimentnote").bind('input propertychange', function() {
				string_validate("#experimentnote");
			}); 
		})
		...
		$(document).on("click", ".add_btn", function() {
			...
			var id;
			$.ajax({
				url : "${root_path}/add/AddExperimentRecord/ExperimentID",
				type : "GET",
				success : function(result) {
					id = result.extend.ExperimentID;
					$("#ID").val(id);
				}
			})
		...
		$(document).on("click", ".look_btn", function() {	
			 window.open("${root_path}/add/LookExperimentRecord?animalID="+ $(this).attr("animalID"));  		
		});
		...
		*/
		$("#submit_btn").click(function(){
			...
			if (string_validate("#experimentpurpose") == 0) {
				return false;
			}
			if (string_validate("#experimentpurpose") == 0) {
				return false;
			}
			if (string_validate("#experimentapproach") == 0) {
				return false;
			}
			if (string_validate("#experimentrecord") == 0) {
				return false;
			}
			if (string_validate("#experimentresult") == 0) {
				return false;
			}
			if (string_validate("#experimentnote") == 0) {
				return false;
			}
			...
			$.ajax({
				url : "${root_path}add/ExperimentRecord/add",
				type : "POST",
