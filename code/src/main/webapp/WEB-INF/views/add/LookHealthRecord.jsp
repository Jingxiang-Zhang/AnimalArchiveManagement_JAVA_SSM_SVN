...
<body>
			...
			<ul class="nav metismenu" id="side-menu">
				...
				<li class="active"><a href="index.html"> <i
					...
					<ul class="nav nav-second-level">
						...
						<li ><a href="${root_path}add/AddHealthRecord">动物繁殖记录添加</a></li>
						<li class="active"><a href="${root_path}add/AddHealthRecord">动物健康记录添加</a></li>
					</ul></li>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <h5>Experiment Animal Health Record Table</h5>
	...
	<script type="text/javascript">	
		...
		function to_page(pn) {
			...
			//用ajax请求查询实验动物档案表
			$.ajax({
				url : "${root_path}/add/LookHealthRecord/query",
