...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <h5>Experiment Animal Experiment Data Record Table</h5>
	...
	<script type="text/javascript">	
		...
		function to_page(pn) {
			...
			//用ajax请求查询实验动物档案表
			$.ajax({
				url : "${root_path}/add/LookExperimentRecord/query",
		...
		function build_emps_table(result) {				
			...
			$.each(emps, function(index, item) {
				...
				var experimentnumberTd = $("<td></td>").append(item.experimentnumber);
				...
				//添加一行数据到表格中
				$("<tr></tr>").append(experimentdateTd).append(experimentnumberTd).append(IDTd).append(experimenternumberTd).append(experimentlocationTd).appendTo("#emps_table tbody");
			});
		}
