			...
			<ul class="nav metismenu" id="side-menu">
				...
				<li class="active"><a href="index.html"> <i
					...
					<ul class="nav nav-second-level">
						...
						<li class="active"><a href="${root_path}add/AddFeedRecord">动物饲养记录添加</a>
						</li>
	            ...
	            <div class="ibox-content m-b-sm border-bottom">
					...
					<ol class="breadcrumb" style='font-size:14px'>
                    	<li class="breadcrumb-item">
                       	...
                       	<li class="breadcrumb-item">
                           	<a href="${root_path}add/AddExperimentRecord">添加子系统</a>
                       	</li>
                       	<li class="breadcrumb-item active">
                           	<strong>动物饲养记录添加</strong>
                       	</li>
                   	</ol>
				</div>
			    		...
			    		<!-- 表单 -->
			      		<form class="form-horizontal" id="add_form">
							...
							<div class="form-group">
						    	...
						    	<div class="col-lg-3">
						      		<input type="text" name="archivenumber" id="experimentnumber" style='font-size:14px' class="form-control" readonly="readonly">
						    	</div>
						    	<label style='font-size:14px' class="col-lg-2 col-lg-offset-1 control-label">饲养记录表编号：</label>
						    	<div class="col-lg-3 ">
						      		<input type="text" name="id" id="ID" style='font-size:14px' class="form-control" readonly="readonly">
						    	</div>
						  	</div>
						  	<div class="form-group">
						    	<label style='font-size:14px' class="col-lg-2 control-label">饲养记录员编号：</label>
						    	<div class="col-lg-3">
						      		<input type="text" name="recorder" id="experimenternumber" style='font-size:14px' class="form-control" readonly="readonly">
						    	</div>	
						    	<label style='font-size:14px' class="col-lg-2 col-lg-offset-1 control-label">饲养日期：</label>
						    	<div class="col-lg-3">
						      		<input type="text" name="recorddate" id="recorddate" style='font-size:14px' class="form-control" placeholder="yyyy-mm-dd">
						    		<!-- 显示错误信息 -->
									<div class="invalid-feedback" style="color:red" id="recorddate_input_feedback"></div>
						    	</div>
						  	</div>		
						  	<div class="form-group">
						    	<label style='font-size:14px' class="col-lg-2 control-label">饲养前状态：</label>
						    	<div class="col-lg-9">
						      		<textarea class="form-control" name="statusbeforefeed" id="statusbeforefeed" rows="5" style='font-size:14px' placeholder="详细描述饲养前状态，在255字以内"></textarea>
						    		<!-- 显示错误信息 -->
									<div class="invalid-feedback" style="color:red" id="statusbeforefeed_input_feedback"></div>
						    	</div>					
						  	</div>					  	
		  					<div class="form-group">
						    	<label style='font-size:14px' class="col-lg-2 control-label">饲养物：</label>
						    	<div class="col-lg-9">
						      		<textarea class="form-control" name="feedobject" id="feedobject" rows="5" style='font-size:14px' placeholder="详细描述饲养物，在255字以内"></textarea>
						    		<!-- 显示错误信息 -->
									<div class="invalid-feedback" style="color:red" id="feedobject_input_feedback"></div>
						    	</div>					
						  	</div>	
						  		<div class="form-group">
						    	<label style='font-size:14px' class="col-lg-2 control-label">饲养过程：</label>
						    	<div class="col-lg-9">
						      		<textarea class="form-control" name="feedprocess" id="feedprocess" rows="10" style='font-size:14px' placeholder="详细描述饲养过程，在255字以内"></textarea>
						    		<!-- 显示错误信息 -->
									<div class="invalid-feedback" style="color:red" id="feedprocess_input_feedback"></div>
						    	</div>					
						  	</div>								  
						</form>
						<!-- 按钮 -->
    ...
    <script type="text/javascript">             
		...
		$(function() {
			...
			$("#animal_achiveID,#animal_kind,#animal_description,#animal_orgi").bind('input propertychange', function() { 	
 			...
 			/*日期输入框绑定前端校验*/
			$("#recorddate").bind('input propertychange', function() {
				date_validate("#recorddate");
			}); 
			
			/*日期输入框绑定前端校验*/
			$("#statusbeforefeed").bind('input propertychange', function() {
				string_validate("#statusbeforefeed");
			}); 

			/*日期输入框绑定前端校验*/
			$("#feedobject").bind('input propertychange', function() {
				string_validate("#feedobject");
			}); 
			
			/*日期输入框绑定前端校验*/
			$("#feedprocess").bind('input propertychange', function() {
				string_validate("#feedprocess");
			}); 
		})
		...
		$(document).on("click", ".add_btn", function() {
			...
			var id;
			$.ajax({
				url : "${root_path}/add/AddFeedRecord/FeedID",
				type : "GET",
				success : function(result) {
					id = result.extend.FeedID;
					$("#ID").val(id);
				}
			})
		...
		$(document).on("click", ".look_btn", function() {	
			 window.open("${root_path}/add/LookFeedRecord?animalID="+ $(this).attr("animalID"));  		
		});
		...
		*/
		$("#submit_btn").click(function(){
			...
			//前端校验
			if (date_validate("#recorddate") == 0) {
				return false;
			}
			if (string_validate("#statusbeforefeed") == 0) {
				return false;
			}	  
			if (string_validate("#feedobject") == 0) {
				return false;
			}
			if (string_validate("#feedprocess") == 0) {
				return false;
			}
			...
			$.ajax({
				url : "${root_path}add/FeedRecord/add",
				type : "POST",
