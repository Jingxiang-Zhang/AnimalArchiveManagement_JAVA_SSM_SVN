...
<body>
		...
		<nav class="navbar-default navbar-static-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav metismenu" id="side-menu">
					...
					<!-- 档案添加子系统 -->
					<li class="active"><a href="index.html"> <i class="glyphicon glyphicon-plus"></i> <span
								class="nav-label">档案添加</span>
						...
						<ul class="nav nav-second-level">
							...
							<li class="active"><a href="${root_path}add/AddBreedRecord">动物繁殖记录添加</a>
							</li>
					...
					<!-- 档案授权管理子系统 -->
					<li><a href="#"> <i class="glyphicon glyphicon-pawn"></i> <span class="nav-label">档案授权管理</span>
							<span class="fa arrow"></span>
						</a>
						<ul class="nav nav-second-level collapse">
					...
					<div class="navbar-header col-lg-4">
						...
						<form role="search" class="navbar-form-custom" action="search_results.html">
							<div class="form-group">
								<input type="text" placeholder="搜索你想要的结果..." class="form-control" name="top-search"
									id="top-search">
							</div>
						</form>
					</div>
					...
					<div class="modal-content">
						...
						<form class="form-horizontal" id="add_form">
							...
							<div class="form-group">
								...
								<div class="col-lg-3">
									<input type="text" name="archivenumber" id="experimentnumber" style='font-size:14px'
										class="form-control" readonly="readonly">
								</div>
								<label style='font-size:14px'
									class="col-lg-2 col-lg-offset-1 control-label">繁殖记录表编号：</label>
								<div class="col-lg-3 ">
									<input type="text" name="id" id="ID" style='font-size:14px' class="form-control"
										readonly="readonly">
								</div>
							</div>
							<div class="form-group">
								<label style='font-size:14px' class="col-lg-2 control-label">繁殖记录员编号：</label>
								<div class="col-lg-3">
									<input type="text" name="recorder" id="experimenternumber" style='font-size:14px'
										class="form-control" readonly="readonly">
								</div>
								<label style='font-size:14px'
									class="col-lg-2 col-lg-offset-1 control-label">繁殖日期：</label>
								<div class="col-lg-3">
									<input type="text" name="recorddate" id="breeddate" style='font-size:14px'
										class="form-control" placeholder="yyyy-mm-dd">
									<!-- 显示错误信息 -->
									<div class="invalid-feedback" style="color:red" id="breeddate_input_feedback"></div>
								</div>
							</div>
							<div class="form-group">
								<label style='font-size:14px' class="col-lg-2 control-label">繁殖描述：</label>
								<div class="col-lg-9">
									<textarea class="form-control" name="breeddescription" id="breeddescription"
										rows="10" style='font-size:14px' placeholder="详细描述繁殖过程，在255字以内"></textarea>
									<!-- 显示错误信息 -->
									<div class="invalid-feedback" style="color:red"
										id="breeddescription_input_feedback"></div>
								</div>
							</div>
						</form>
						<!-- 按钮 -->
						<div class="modal-footer">
							<button type="button" class="btn btn-default col-lg-1 col-lg-offset-8"
								data-dismiss="modal">关闭</button>
							<button type="button" class="btn btn-primary col-lg-2" id="submit_btn"
								data-dismiss="modal">添加到数据库</button>
						</div>
					</div>
				</div>
			</div>
	...
	<script type="text/javascript">
		...
		$(function () {
			...
			/*日期输入框绑定前端校验*/
			$("#breeddate").bind('input propertychange', function () {
				date_validate("#breeddate");
			});

			/*日期输入框绑定前端校验*/
			$("#breeddescription").bind('input propertychange', function () {
				string_validate("#breeddescription");
			});
		})
		...
		*/
		$(document).on("click", ".add_btn", function () {
			...
			var id;
			$.ajax({
				url: "${root_path}/add/AddBreedRecord/BreedID",
				type: "GET",
				success: function (result) {
					id = result.extend.BreedID;
					$("#ID").val(id);
				}
			})
		...
		$(document).on("click", ".look_btn", function () {
			window.open("${root_path}/add/LookBreedRecord?animalID=" + $(this).attr("animalID"));
		});
		...
		*/
		$("#submit_btn").click(function () {
			//前端校验
			if (date_validate("#breeddate") == 0) {
				return false;
			}
			if (string_validate("#breeddescription") == 0) {
				return false;
			}
			...
			//发送ajax请求，添加数据
			$.ajax({
				url: "${root_path}add/BreedRecord/add",
				type: "POST",
