...
<body background="static/login.jpg" style=" background-repeat:no-repeat ;background-size:100% 100%;
	...
	<script src="static/login/js/ios-parallax.js"></script>
	<script type="text/javascript">
	...
	<div id="menu"
		style="width: 170px; background: #CCC;position: absolute; display: none;">
		<a class="dropdown-item" href="login.jsp"> <span class="nav-label">良辰美景主题</span>
			<span class="glyphicon glyphicon-ok">&nbsp;</span>
		</a> <a class="dropdown-item" href="login2.jsp">黑客帝国主题</a>
